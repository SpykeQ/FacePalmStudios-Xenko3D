...
[assembly: SiliconStudio.Core.Serialization.Serializers.AssemblySerializerFactory(Type = typeof(SiliconStudio.DataSerializers.Capstone_ProjectSerializerFactory))]
...
namespace SiliconStudio.DataSerializers
{
    // Assembly attributes that defines supported serializer (only generics one so that other assemblies can do generic instantiations by themselves)
   	public static class Capstone_ProjectSerializerFactory
	{
	    [SiliconStudio.Core.ModuleInitializer]
        internal static void Initialize()
        {
			var assemblySerializers = new AssemblySerializers(typeof(Capstone_ProjectSerializerFactory).GetTypeInfo().Assembly);
			...
			assemblySerializers.Modules.Add(typeof(SiliconStudio.DataSerializers.Capstone_Project_GameSerializerFactory).GetTypeInfo().Module);
            ...
            AssemblyRegistry.Register(typeof(Capstone_ProjectSerializerFactory).GetTypeInfo().Assembly, AssemblyCommonCategories.Engine);
        }
	}
}
