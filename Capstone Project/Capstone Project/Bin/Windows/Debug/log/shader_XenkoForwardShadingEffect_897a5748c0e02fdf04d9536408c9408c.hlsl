...
@P   - Material.PixelStageSurfaceShaders: mixin MaterialSurfaceArray [{layers = [mixin MaterialSurfaceSetStreamFromComputeColor<matEmissive,rgba> [{computeColorSource = ComputeColorTextureScaledOffsetDynamicSampler<Material.EmissiveMap,TEXCOORD0,Material.Sampler.i0,rgba,Material.TextureScale,Material.TextureOffset>}], mixin MaterialSurfaceSetStreamFromComputeColor<matEmissiveIntensity,r> [{computeColorSource = ComputeColorConstantFloatLink<Material.EmissiveIntensity>}], MaterialSurfaceEmissiveShading<false>]}]
...
@C    scale_id140 => Material.TextureScale
@C    offset_id141 => Material.TextureOffset
@C    constantFloat_id143 => Material.EmissiveIntensity
...
******  Resources    ******
***************************
@R    Texture_id137 => Material.EmissiveMap [Stage: None, Slot: (-1--1)]
@R    Texture_id137 => Material.EmissiveMap [Stage: None, Slot: (-1--1)]
@R    Sampler_id138 => Material.Sampler.i0 [Stage: None, Slot: (-1--1)]
@R    Sampler_id138 => Material.Sampler.i0 [Stage: None, Slot: (-1--1)]
@R    PerMaterial => PerMaterial [Stage: None, Slot: (-1--1)]
@R    PerDraw => PerDraw [Stage: Vertex, Slot: (0-0)]
@R    PerView => PerView [Stage: Vertex, Slot: (1-1)]
@R    Sampler_id138 => Material.Sampler.i0 [Stage: Pixel, Slot: (0-0)]
@R    Texture_id137 => Material.EmissiveMap [Stage: Pixel, Slot: (0-0)]
...
//
#line 192 "C:\Users\Joseph Braunstein\Desktop\FacePalmStudios-Xenko3D\Capstone Project\Capstone Project\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_897a5748c0e02fdf04d9536408c9408c.hlsl"
...
@G    Pixel => 3c536644e23c87a1bcfb02ed2f6755a8
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
// {
//
//   float2 scale_id140;                // Offset:    0 Size:     8
//   float2 offset_id141;               // Offset:    8 Size:     8
//   float constantFloat_id143;         // Offset:   16 Size:     4
//
// }
//
//
...
// Name                                 Type  Format         Dim Slot Elements
// ------------------------------ ---------- ------- ----------- ---- --------
// Sampler_id138                     sampler      NA          NA    0        1
// Texture_id137                     texture  float4          2d    0        1
...
//
#line 111 "C:\Users\Joseph Braunstein\Desktop\FacePalmStudios-Xenko3D\Capstone Project\Capstone Project\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_897a5748c0e02fdf04d9536408c9408c.hlsl"
mad r0.xy, v3.xyxx, cb0[0].xyxx, cb0[0].zwzz
sample_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t0.xyzw, s0  // r0.x <- <Compute_id69 return value>.x; r0.y <- <Compute_id69 return value>.y; r0.z <- <Compute_id69 return value>.z
...
***************************
*************************/
const static bool TUseAlphaFromEmissive_id145 = false;
Texture2D Texture_id137;
...
void ResetStream_id63()
{
}
float4 Compute_id71()
{
    return float4(constantFloat_id143, constantFloat_id143, constantFloat_id143, constantFloat_id143);
}
float4 Compute_id69(inout PS_STREAMS streams)
{
    return Texture_id137.Sample(Sampler_id138, streams.TexCoord_id127 * scale_id140 + offset_id141).rgba;
}
...
{
    streams.matEmissiveIntensity_id57 = Compute_id71().r;
}
void Compute_id77(inout PS_STREAMS streams)
{
    streams.matEmissive_id56 = Compute_id69(streams).rgba;
}
